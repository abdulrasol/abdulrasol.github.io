...
const app = Vue.createApp({
    ...
    methods: {
        toggleLanguage() {
            ...
            localStorage.setItem('store_management_lang', this.lang);
            document.title = this.t.pageTitle;
        },
        toggleTheme() {
            this.isDarkMode = !this.isDarkMode;
            localStorage.setItem('store_management_theme', this.isDarkMode ? 'dark' : 'light');
            if (this.isDarkMode) {
        ...
        initLanguage() {
            ...
            const savedLang = localStorage.getItem('store_management_lang');
        ...
        initTheme() {
            const savedTheme = localStorage.getItem('store_management_theme');
            if (savedTheme) {
    ...
    mounted() {
        ...
        window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', e => {
            if (!localStorage.getItem('store_management_theme')) {
