...
const app = Vue.createApp({
    ...
    methods: {
        toggleLanguage() {
            ...
            localStorage.setItem('watt_lang', this.lang);
            document.title = this.t.pageTitle;
        },
        toggleTheme() {
            this.isDarkMode = !this.isDarkMode;
            localStorage.setItem('watt_theme', this.isDarkMode ? 'dark' : 'light');
            if (this.isDarkMode) {
        ...
        initLanguage() {
            ...
            const savedLang = localStorage.getItem('watt_lang');
        ...
        initTheme() {
            const savedTheme = localStorage.getItem('watt_theme');
            if (savedTheme) {
    ...
    mounted() {
        ...
        window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', e => {
            if (!localStorage.getItem('watt_theme')) {
