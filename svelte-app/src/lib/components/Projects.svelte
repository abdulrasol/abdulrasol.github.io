            ...
            <div class="project-actions">
              ...
              {#if project.liveUrl}
                <a href={project.liveUrl} class="btn btn-primary btn-sm">
                  ...
                  {(project.liveUrl && (project.liveUrl.includes('/madarik') || project.liveUrl.includes('/meterlog') || project.liveUrl.includes('/store-management'))) ? t('projects.landingPage', $locale) : t('projects.liveDemo', $locale)}
                </a>
              {/if}
