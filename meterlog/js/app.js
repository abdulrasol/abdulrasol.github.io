...
const app = Vue.createApp({
    ...
    methods: {
        toggleLanguage() {
            ...
            localStorage.setItem('meterlog_lang', this.lang);
            document.title = this.t.pageTitle;
        },
        toggleTheme() {
            this.isDarkMode = !this.isDarkMode;
            localStorage.setItem('meterlog_theme', this.isDarkMode ? 'dark' : 'light');
            if (this.isDarkMode) {
        ...
        initLanguage() {
            ...
            const savedLang = localStorage.getItem('meterlog_lang');
        ...
        initTheme() {
            const savedTheme = localStorage.getItem('meterlog_theme');
            if (savedTheme) {
    ...
    mounted() {
        ...
        window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', e => {
            if (!localStorage.getItem('meterlog_theme')) {
